"""
Annotation-Aware Multi-Perspective Retriever for Polaris.
"""
...
from polaris_kg.retrieval.packs import ToolManager

logger = logging.getLogger("polaris_kg.retrieval.retriever")
