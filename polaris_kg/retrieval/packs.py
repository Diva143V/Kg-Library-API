"""
Domain Packs Retrieval Framework for Polaris.
...
logger = logging.getLogger("polaris_kg.retrieval.packs")
    ...
    def search(self, query: str) -> List[Dict[str, Any]]:
        ...
        try:
            req = urllib.request.Request(
                ...
                headers={"User-Agent": "Polaris-TinyFishClient/1.0"}
            )
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            req = urllib.request.Request(
                self.endpoint,
                data=data,
                headers={"Content-Type": "application/json", "User-Agent": "Polaris-MCPClient/1.0"}
            )
            with urllib.request.urlopen(req, timeout=2.0) as response:
                return json.loads(response.read().decode())
        except Exception as e:
